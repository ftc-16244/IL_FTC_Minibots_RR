...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(5, 0, 0,12.6);
    ...
    public static double GEAR_RATIO = 24./16.; // output (wheel) speed / input (motor) speed
